...
keep AID-PRISON4 H1GH39-H1GH46 H1RP* H1MO* H4HS* H4LM* H4PE* H4OD* H4GH* H4ID* H1GI4 H1GI6* H4ED1-H4ED3A H4EC* GSWGT4 GSWGT4_2 GSWGT134
...
//Race
ren H1GI4 race_hispanic
ren H1GI6A race_white
ren H1GI6B race_black
ren H1GI6D race_asian
ren H1GI6C race_native
ren H1GI6E race_other
//Weights
...
recode insured (0 = 3) (1 = 1), gen(insur_cat)
replace insur_cat = 2 if noins_dont_want == 1
label define CATS 1 "Insured" 2 "Voluntary Uninsured" 3 "Non-voluntary Uninsured"
label values insur_cat CATS
//Employment Categories
gen empstat = unemp_stat + 1
replace empstat = 1 if employed == 1
replace empstat = 1 if empstat == . & H4LM1 == 1
